...
// =====================================================================
// AUTH: registration, email verification, login, forgot/reset password
// =====================================================================
...
// =====================================================================
// CONTACT MESSAGES ("Connect With Us" form)
// =====================================================================
...
// =====================================================================
// GIVING RECORDS ("Give" page — M-Pesa / bank transfer notifications)
// =====================================================================
...
// the moment someone pays, no prompt needed from our side)
// =====================================================================

// --- Safaricom calls this BEFORE completing the transaction, to check   ---
// --- whether we want to accept it. We always accept — Safaricom itself ---
// --- already validated the shortcode/account format on their end.      ---
app.post('/api/giving/c2b/validation', async (req, res) => {
  res.json({ ResultCode: 0, ResultDesc: 'Accepted' });
});

// --- Safaricom calls this AFTER a payment to your Paybill completes. ---
// --- This is the source of truth — we auto-create a confirmed giving  ---
// --- record here with no involvement from the frontend at all.        ---
// Must be reachable at a public HTTPS URL — set MPESA_CONFIRMATION_URL accordingly.
app.post('/api/giving/c2b/confirmation', async (req, res) => {
  try {
    ...
    console.error(err);
    // Still acknowledge — Safaricom will retry indefinitely otherwise, and
    // this already happened on their end regardless of our DB hiccup.
    res.json({ ResultCode: 0, ResultDesc: 'Accepted' });
  }
});

// =====================================================================
// M-PESA STK PUSH ("Pay Now" on the Give page — we prompt the customer's
// phone directly; the customer enters their M-Pesa PIN there, never on
// our site. This is separate from the C2B flow above, which only fires
// when someone dials the Paybill manually.)
// =====================================================================
...
// Body: { phone: '2547XXXXXXXX', amount: 500, accountReference, description }
...
// --- Safaricom calls this directly (not the browser) once the customer ---
// --- has entered their PIN on their phone and the transaction is done.  ---
// Must be reachable at a public HTTPS URL — set MPESA_STK_CALLBACK_URL accordingly.
...
// =====================================================================
// EVENT REGISTRATIONS ("Register" button on the Events page)
// =====================================================================
