...
import { Menu, X, Home as HomeIcon, Info, Users, Play, Calendar, Phone, Heart } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-semibold text-2xl text-white">FPFK CHURCH KITENGELA</div>
              <div className="text-xs text-indigo-300 -mt-1">Est. 2005</div>
            </div>
          </div>
